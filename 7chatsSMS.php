...
namespace Bizchats\7chatsSMS;

use Bizchats\7chatsSMS\Drivers\Driver;
...
$driverClass = 'Bizchats\\7chatsSMS\\Drivers\\'. ucfirst($default_sms_driver) . 'SMSDriver';
...
$driverClass = 'Bizchats\\7chatsSMS\\Drivers\\'. ucfirst($default_voice_sms_driver) . 'VoiceDriver';
$this->voiceDriver = new $driverClass($voice_config);
} else {
echo $default_voice_sms_driver . ' Voice configurations not set in 7chats-sms config file.';
}
}
} catch (Exception $e) {
